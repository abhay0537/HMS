...
admin_router.patch("/doctor/:id", auth_middleware, role_check, admin_contoller.update_doctor);
admin_router.delete("/doctor/:id", auth_middleware, role_check, admin_contoller.delete_doctor);
admin_router.get("/services", auth_middleware, role_check, admin_contoller.get_services);
admin_router.post("/services", auth_middleware, role_check, admin_contoller.add_service);
admin_router.patch("/services/:id", auth_middleware, role_check, admin_contoller.update_service);
admin_router.delete("/services/:id", auth_middleware, role_check, admin_contoller.delete_service);
